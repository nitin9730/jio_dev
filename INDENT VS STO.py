...
sql = f'''select o.channel_order_id,o.created_at  ,p.order_id ,p.quantity ,p.processed_quantity,p.sku,p.seq_id,o.sto_number ,o.prm_id,p.processed_unit_price ,srr.response_entity  from orders o  
